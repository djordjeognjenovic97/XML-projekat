...
public class QueryZalbacutanjeDTO {
    ...
    public QueryZalbacutanjeDTO() {
    }

    public QueryZalbacutanjeDTO(String brojPredmeta, String imePodnosioca, String prezimePodnosioca, String datum, String mesto) {
