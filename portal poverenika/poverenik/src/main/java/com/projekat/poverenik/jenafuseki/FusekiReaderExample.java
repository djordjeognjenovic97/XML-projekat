...
public class FusekiReaderExample {
    ...
    public static ArrayList<String> executeQuery(Map<String,String> params, String metadataUri) throws IOException {
        ...
        else if(metadataUri.contains("izvestaj")) {
            queryFilepath = queryFilepath + "sparqlIzvestaj.rq";
        }
        ...
        while(results.hasNext()){
            ...
            while(variableBindings.hasNext()){
                ...
                if(varName.contains("broj_predmeta") || varName.contains("broj_resenja") || varName.contains("id")){
