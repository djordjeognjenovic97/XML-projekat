...
public class FusekiWriterExample {
    ...
    public static void saveRDF(String filepath, String metadataUri) throws IOException {
        ...
        processor.execute();
        System.out.println("[INFO] Writing the triples to a named graph \"" + metadataUri + "\".");
        String sparqlUpdate = SparqlUtil.insertData(conn.dataEndpoint + metadataUri,
