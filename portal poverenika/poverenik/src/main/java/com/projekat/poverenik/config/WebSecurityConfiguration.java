package com.projekat.poverenik.config;
import com.projekat.poverenik.security.TokenUtils;
import com.projekat.poverenik.security.auth.RestAuthenticationEntryPoint;
import com.projekat.poverenik.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .cors().and()
                //ZA LOGOUT KASNIJE
                //.logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessUrl("/auth/login").and()
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/login", "/recover/**");
