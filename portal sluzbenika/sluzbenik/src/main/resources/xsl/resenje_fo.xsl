...
<xsl:stylesheet
        ...
        xmlns="https://github.com/djordjeognjenovic97/XML-projekat/resenja"
        version="2.0">
    <xsl:template match="/">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master
                        master-name="resenjeStranica" page-height="29.7cm" page-width="21cm"
            ...
            <fo:page-sequence master-reference="resenjeStranica">
