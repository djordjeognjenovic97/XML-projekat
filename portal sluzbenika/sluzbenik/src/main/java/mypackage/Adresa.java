...
@XmlRootElement(name = "adresa", namespace = "https://github.com/djordjeognjenovic97/XML-projekat/obavestenjecir")
public class Adresa {
    ...
    @XmlElement(name = "br_ulice", namespace = "https://github.com/djordjeognjenovic97/XML-projekat/obavestenjecir")
